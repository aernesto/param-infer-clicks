function lklh=lhd_nonlin_sing_tr_gauss_clicks(dec_data, npart, left_clicks, right_clicks, td, kappa, h_sample, init_cond, noise_stdev)
...
parfor part_nb = 1:npart
    rng('shuffle')
    dec = gauss_noise_nonlin_decide(td, left_clicks, right_clicks, kappa, h_sample, init_cond, noise_stdev);
    if dec == dec_data
        ncorrect = ncorrect + 1;
    end
end
