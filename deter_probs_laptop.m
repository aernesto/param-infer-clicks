...
nonlinear_decisions = h5read(dbname, dsetname_decision_nonlin, [2,10001], [numsamples, numtrials]);
...
reference_decision_nonlinear = h5read(dbname, dsetname_decision_nonlin, [1,10001], [1, numtrials]);
