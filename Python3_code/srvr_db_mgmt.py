...
def update_linear_decision_data(file_name, group_name, create_nonlin_db=False, verbose=False):
    """
...
if __name__ == '__main__':
    """
    DB content before launching script:
    """
    db_content = {'S8':{'group_name': 'lr15hr101.258639865h1T2',
                        'info_dset_name': 'lr15hr101.258639865h1T2/trial_info',
                        'trials_dset_name': 'lr15hr101.258639865h1T2/trials',
                        'lr': 15,
                        'hr': 101.258639865},
                'S05':{'group_name': 'lr15hr17.8664640249h1T2',
                       'info_dset_name': 'lr15hr17.8664640249h1T2/trial_info',
                       'trials_dset_name': 'lr15hr17.8664640249h1T2/trials',
                       'lr': 15, 
                       'hr': 17.8664640249},
                'S3':{'group_name': 'lr15hr36.5367250374h1T2',
                      'info_dset_name': 'lr15hr36.5367250374h1T2/trial_info',
                      'trials_dset_name': 'lr15hr36.5367250374h1T2/trials',
                      'lr': 15,
                      'hr': 36.5367250374}}
    smap = {'S8': 8, 'S05': 0.5, 'S3': 3}
    # parameter vectors
    a_S = np.array([0.5,3,8])  # np.arange(0.5, 6.1, 0.5)
